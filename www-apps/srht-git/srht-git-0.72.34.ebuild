...
src_compile() {
	...
	# FIXME: API doesn't compile, I don't need it right now, so away it goes for now
	#cd "${S}/api"
	#go build -o gitsrht-api || die 'Failed to build gitsrht-api'
	cd "${S}/gitsrht-dispatch"
	go build || die 'Failed to build gitsrht-dispatch'
	cd "${S}/gitsrht-keys"
	go build || die 'Failed to build gitsrht-keys'
	cd "${S}/gitsrht-shell"
	go build || die 'Failed to build gitsrht-shell'
	cd "${S}/gitsrht-update-hook"
	go build || die 'Failed to build gitsrht-update-hook'
}
