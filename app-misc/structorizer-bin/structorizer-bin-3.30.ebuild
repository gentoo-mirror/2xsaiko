...
src_install() {
	...
	dosym "../../opt/${PN}/structorizer.sh" /usr/bin/structorizer
	dosym "../../opt/${PN}/Arranger.sh" /usr/bin/arranger
	...
	make_desktop_entry "${PN}" "Structorizer" "${PN}" "Education;" "StartupWMClass=structorizer"
	make_desktop_entry "arranger" "Arranger" "${PN}" "Education;" "StartupWMClass=structorizer"
}
